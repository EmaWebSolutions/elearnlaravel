                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="notice-board-action-btns">
                                        <a href="{{ route('organization.notice-board.create', $course->uuid) }}" class="theme-btn theme-button1 default-hover-btn">{{__('Add Notice')}}</a>
                                        <a href="{{ route('organization.notice-board.index', $course->uuid) }}" class="theme-btn theme-button1 green-theme-btn default-hover-btn">{{ __('View List') }}</a>
                                    </div>
                                </td>
                            </tr>
                            @endforeach
