<div class="card instructor-item search-instructor-item position-relative text-center border-0 custom-card {{ $type == INSTRUCTOR_CARD_TYPE_THREE ? 'p-20' : 'p-30' }} px-3">
    @php
