                                        ...
                                        @foreach($faqQuestions as $faqQuestion)
                                            <div data-repeater-item="" class="form-group row">
                                                ...
                                                <div class="custom-form-group mb-3 col-lg-5">
                                                    <label for="question_{{ @$faqQuestion['id'] }}" class="text-lg-right text-black"> {{ __('Question') }} </label>
                                                    <div class="">
                                                ...
                                                <div class="custom-form-group mb-3 col-lg-6">
                                                    <label for="answer_{{ @$faqQuestion['id'] }}" class="text-lg-right text-black"> {{ __('Answer') }} </label>
                                                    <div class="">
                                                        <textarea name="answer" id="answer_{{ @$faqQuestion['id'] }}" rows="5" placeholder="{{ __('Answer') }}"
                                    ...
                                    @else
                                        <div data-repeater-item="" class="form-group row ">
                                            ...
                                            <div class="custom-form-group mb-3 col-lg-6">
                                                ...
                                                <textarea name="answer" id="answer" class="form-control"  placeholder="{{ __('Answer') }}" rows="5" required></textarea>
                                            </div>
