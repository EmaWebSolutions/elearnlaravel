                    ...
                    <div class="email-inbox__area bg-style">
                        ...
                        <form action="{{route('settings.general_setting.cms.update')}}" method="post" class="form-horizontal">
                            ...
                            <div class="form-group text-black row mb-3">
                                <label class="col-lg-3">{{ __('Measurement ID') }}<span class="text-danger">*</span></label>
                                <div class="col-lg-9">
                                    <input type="text" name="measurement_id" value="{{ get_option('measurement_id') }}" placeholder="{{ __("Measurement ID") }}" class="form-control" required>
                                </div>
                            </div>
