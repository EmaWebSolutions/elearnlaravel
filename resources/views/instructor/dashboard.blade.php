...
@section('breadcrumb')
    <div class="page-banner-content text-center">
        <h3 class="page-banner-heading text-white pb-15">
            Hey, {{ auth::user()->instructor ? auth::user()->instructor->name : '' }}
            <img src="{{ asset('frontend/assets/img/student-profile-img/waving-hand.png') }}" alt="student" class="me-2">
        </h3>
            ...
            <div class="row instructor-dashboard-top-part instructor-only-dashboard-top-part">
                ...
                <div class="col-md-4 mb-30">
                    <div class="instructor-dashboard-top-part-item d-flex align-items-center radius-8">
                        ...
                        <div class="flex-grow-1 ms-3">
                            <h6 class="para-color font-11 font-semi-bold">{{ __('Best Selling Course') }}</h6>
