                                ...
                                <td>
                                    @if($course->certificate)
                                        <div class="red-blue-action-btns">
                                            <a href="{{route('instructor.certificate.edit', [$course->certificate->uuid])}}" class="theme-btn default-edit-btn-blue">{{__('Edit Certificate')}}</a>
                                            <a href="{{route('instructor.certificate.view', [$course->certificate->uuid])}}" class="theme-btn theme-button1 green-theme-btn default-hover-btn">{{__('View Certificate')}}</a>
                                        </div>
                                    @else
                                        <div class="red-blue-action-btns">
                                            <a href="{{route('instructor.certificate.add', [$course->uuid])}}" class="theme-btn theme-button1 default-hover-btn">{{ __('Add Certificate') }}</a>
