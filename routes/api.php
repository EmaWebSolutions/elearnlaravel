...
Route::post('/payment-order-notify/{id}', [PaymentConfirmController::class, 'paymentOrderNotifier']);
Route::post('/payment-subscription-notify/{id}', [PaymentConfirmController::class, 'paymentSubscriptionNotifier']);
Route::post('/payment-wallet-notify/{id}', [PaymentConfirmController::class, 'paymentWalletRechargeNotifier']);
// End:: Course
...
Route::middleware('auth:api')->group(function () {
    Route::group(['prefix' => 'student', 'middleware' => ['student', 'local']], function () {
        ...
        Route::get('my-course/{slug}/{action_type?}/{quiz_uuid?}/{answer_id?}', [MyCourseController::class, 'myCourseShow'])->middleware('course.access');
